...
import { OrganizationRootLink } from "@/components/public/organization-root-link"
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            ...
            <Button className="mt-4">
              <OrganizationRootLink>{t("common.back")}</OrganizationRootLink>
            </Button>
          </CardContent>
        </Card>
      </div>
...
<Link href={appointmentRoutes.href("/booking")}>
                   <Calendar className="h-3 w-3" />
                    <p className="text-xs">{t("organization.bookNow")}</p>
                 </Link>
               </Button>
               <Button variant="secondary" className="gap-2">
                 <Link href={appointmentRoutes.href("/my-appointments")}>
                   <Calendar className="h-3 w-3" />
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <Button variant="outline">
              <Link href={appointmentRoutes.href("/services")}>
                {t("dashboard.viewAll")}
                    ...
                    <div className="space-y-3">
                      {category.services.slice(0, 3).map((service) => (
                        ...
                        >
                          <div className="flex-1 min-w-0">
                            <Link
                              href={appointmentRoutes.href(`/services/${service.slug || service.id}`)}
                      ...
                      {category.services.length > 3 && (
                        <Button variant="ghost" size="sm" className="w-full">
                          <Link href={appointmentRoutes.href(`/services?category=${category.id}`)}>
