        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            ...
            <Button className="mt-4">
              <Link href={appointmentRoutes.href("/services")}>{t("common.back")}</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
...
<Link 
                   href={appointmentRoutes.href(`/booking?service=${service.id}`)} className="block">
            ...
            <Card>
              ...
              <CardContent>
<Link 
                   href={appointmentRoutes.href(`/services?category=${service.category.id}`)}
