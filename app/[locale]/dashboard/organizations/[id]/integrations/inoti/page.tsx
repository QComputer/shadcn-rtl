...
import { InotiAccountConsoleClient } from "./inoti-account-console-client";
...
export default async function OrganizationInotiPage({
  params,
}: {
  ...
  return <InotiAccountConsoleClient locale={locale} organizationId={id} />;
}
