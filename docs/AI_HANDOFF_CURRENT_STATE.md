...
- Local Docker MOCK E2E remains partial because the deployed Render MOCK coordinator still returns HTTP 500 for the product-image create mutation after the deployed schema readiness fix.
