...
The current working baseline after P106 PWA/Push/SMS source acceptance and secretless packaging gate is source-validator green after the P106 validation gate.

P106 is the active acceptance/packaging gate. Creative Studio work must not start until P106 is green.
