...
B2B repositioning baseline: BB-B2B-P00, BB-B2B-P01, BB-B2B-P02, BB-B2B-P03, BB-B2B-P04, BB-B2B-P05, BB-B2B-P06, and BB-B2B-P07 completed. Public route policy and decision matrix are documented in `docs/b2b-public-repositioning/`. BB-B2B-P03 replaces the marketplace-like homepage with a Persian-first B2B landing page in `app/[locale]/page.tsx`. BB-B2B-P04 adds curated demo business portfolio and seed strategy. BB-B2B-P05 documents public discovery restriction and demo-only API policy. BB-B2B-P06 adds conversion funnel pages (request-demo, contact, pricing). BB-B2B-P07 adds feature pages (`app/[locale]/features/page.tsx`) and dashboard showcase (`app/[locale]/dashboard-showcase/page.tsx`). Next B2B phase: BB-B2B-P08 — SEO, Trust, Legal, Analytics Hardening.
...
P120 should harden the reviewed generated-asset apply workflow with clearer rollback UX, confirmation evidence, and operator-visible recovery paths while preserving selected-candidate review before any public logo/cover mutation.
