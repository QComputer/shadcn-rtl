...
The current working baseline after P102 Notification templates, routing, and delivery policies is source-validator green after the P102 validation gate.
