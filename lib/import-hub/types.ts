...
export type ImportJobSummary = {
  phase: "P68_FOUNDATION" | "P69_CSV_EXCEL_PRODUCT_IMPORTER" | "P70_MANUAL_INSTAGRAM_FANPAGE_IMPORT" | "P71_TEXT_PRODUCT_EXTRACTION"
  draftFirst: true
  importerEnabled: false | "spreadsheet-draft-parser" | "manual-instagram-content-drafts" | "local-rule-based-text-product-extractor"
  message: string
