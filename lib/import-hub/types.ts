...
export type ImportJobSummary = {
  ...
  draftFirst: true
  importerEnabled: false | "spreadsheet-draft-parser" | "manual-instagram-content-drafts" | "local-rule-based-text-product-extractor" | "dry-run-menu-ocr-fixture" | "snappfood-url-fallback" | "snappmarket-url-fallback" | "manual-telegram-content-drafts"
  message: string
