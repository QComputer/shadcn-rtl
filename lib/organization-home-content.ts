...
const ITALIANO_13_FA: OrganizationHomeContent = {
  ...
  hero: {
    ...
    statement: "طعم ایتالیایی، با Caseهای محلی",
    description: "پیتزا، برگر، پاستا و غذاهای فرنگی تازه در قلب شهرکرد. سفارش مستقیم یا تماس برای رزرو.",
    desktopImage: homeAsset("restaurant-13", "hero/hero-main.webp", "رستوران ایتالیایی سیزده شهرکرد", 1600, 900),
    mobileImage: homeAsset("restaurant-13", "hero/hero-main-mobile.webp", "رستوران ایتالیایی سیزده شهرکرد", 900, 1200),
  ...
  collections: [
    { title: "پیتزا", image: homeAsset("restaurant-13", "collections/featured-pizza.webp", "پیتزا میکس سیزده", 720, 540) },
    { title: "برگر", image: homeAsset("restaurant-13", "collections/featured-burger.webp", "برگر ذغالی", 720, 540) },
    { title: "پاستا", image: homeAsset("restaurant-13", "collections/featured-pasta.webp", "پاستا آلفردو", 720, 540) },
    { title: "ویژه‌ها", image: homeAsset("restaurant-13", "collections/featured-special-dish.webp", "چیکن استیک پارمزان", 720, 540) },
  ],
  featured: {
    title: "تازه‌های منو",
    ...
    items: [
      { title: "پیتزا میکس سیزده", image: homeAsset("restaurant-13", "products/pizza-signature.webp", "پیتزا میکس سیزده", 640, 640) },
      { title: "برگر ذغالی", image: homeAsset("restaurant-13", "products/burger-signature.webp", "برگر ذغالی", 640, 640) },
      { title: "پاستا آلفردو", image: homeAsset("restaurant-13", "products/pasta-alfredo.webp", "پاستا آلفردو", 640, 640) },
      { title: "چیکن استیک پارمزان", image: homeAsset("restaurant-13", "products/chicken-parmesan.webp", "چیکن استیک پارمزان", 640, 640) },
      { title: "بشقاب سوخاری", image: homeAsset("restaurant-13", "products/crispy-platter.webp", "بشقاب سوخاری", 640, 640) },
    ],
  },
  lookbook: {
    title: "منوهای رستوران ۱۳",
    description: "نگاهی به چند品类 محبوب و تازه‌های آشپزخانه رستوران.",
    items: [
      { title: "پیتزا", image: homeAsset("restaurant-13", "products/pizza-signature.webp", "پیتزا", 800, 1000) },
      { title: "برگر", image: homeAsset("restaurant-13", "products/burger-signature.webp", "برگر", 800, 1000) },
      { title: "پاستا", image: homeAsset("restaurant-13", "products/pasta-alfredo.webp", "پاستا", 800, 1000) },
      { title: "ویژه‌ها", image: homeAsset("restaurant-13", "products/chicken-parmesan.webp", "ویژه‌ها", 800, 1000) },
    ],
  },
  campaign: {
