...
add("roadmap keeps P94 complete in current progression", /\| P94 \| AI media seller-facing paid provider state UX\. \|/.test(roadmap) && /Completed through \*\*P97 - PWA foundation and install experience\*\*/.test(roadmap) && /P98 - Offline shell, caching, and PWA quality gates/.test(roadmap))
