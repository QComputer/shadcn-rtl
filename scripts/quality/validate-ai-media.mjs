...
add("package exposes AI media validators", /"quality:ai-media":\s*"node scripts\/quality\/validate-ai-media\.mjs"/.test(packageJson) && /"quality:ai-media-health-gate"/.test(packageJson) && /"quality:ai-media-mock-flow"/.test(packageJson) && /"quality:ai-media-client"/.test(packageJson) && /"quality:ai-media-mock"/.test(packageJson) && /"quality:ai-media-deployed-smoke"/.test(packageJson) && /"smoke:deployed:ai-media"/.test(packageJson))
