...
add("roadmap keeps P109 complete in P110 progression", /Completed through \*\*P113 - Creative Studio generated-asset selection polish and deployed acceptance\*\*/.test(roadmap) && /\| P109 \| Creative Studio dashboard shell and read-only job review\. \|/.test(roadmap) && /\| P110 \| Creative Studio apply controls and cache-safe public asset updates\. \|/.test(roadmap))
add("source of truth names P110 baseline", /after P113 Creative Studio generated-asset selection polish and deployed acceptance/.test(sourceOfTruth) && /Creative Studio dashboard review exists/.test(sourceOfTruth))
