...
add("README marks P113 complete and P114 next", /Latest completed implementation phase:\s+\*\*P120 - Creative Studio reviewed asset apply and rollback workflow\*\*/.test(readme) && /Recommended next phase:\s+\*\*P120B - Customer order lifecycle notifications and guest SMS dry-run review\*\*/.test(readme));
add("roadmap marks P113 complete and P114 next", /Completed through \*\*P120 - Creative Studio reviewed asset apply and rollback workflow\*\*/.test(roadmap) && /\| P113 \| Creative Studio generated-asset selection polish and deployed acceptance\. \|/.test(roadmap) && /\| P114 \| Creative Studio organization-brand generation planning and readiness gate\. \|/.test(roadmap));
