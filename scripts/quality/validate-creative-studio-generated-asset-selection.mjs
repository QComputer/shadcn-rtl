...
add("README marks P113 complete and P114 next", /Latest completed implementation phase:\s+\*\*P116 - Creative Studio organization logo and cover generated-asset acceptance\*\*/.test(readme) && /Recommended next phase:\s+\*\*P117 - Creative Studio organization-brand provider execution rollout gate\*\*/.test(readme));
add("roadmap marks P113 complete and P114 next", /Completed through \*\*P116 - Creative Studio organization logo and cover generated-asset acceptance\*\*/.test(roadmap) && /\| P113 \| Creative Studio generated-asset selection polish and deployed acceptance\. \|/.test(roadmap) && /\| P114 \| Creative Studio organization-brand generation planning and readiness gate\. \|/.test(roadmap));
add("source of truth names P113 baseline", /after P116 Creative Studio organization logo and cover generated-asset acceptance/.test(sourceOfTruth) && /Creative Studio generated-asset selection polish exists/.test(sourceOfTruth));
