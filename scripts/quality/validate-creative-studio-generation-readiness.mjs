...
add("roadmap marks P112 complete and P113 next", /Completed through \*\*P120D - SMS.ir provider completion\*\*/.test(roadmap) && /\| P111 \| Creative Studio generation readiness gate and AI-service contract sync\. \|/.test(roadmap) && /\| P112 \| Creative Studio product-image generation request controls and long-running job UX\. \|/.test(roadmap));
