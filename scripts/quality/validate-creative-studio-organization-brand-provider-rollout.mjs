...
add("readiness exposes P117 rollout gate without public auto-apply", /organizationBrandProvider/.test(readiness) && /providerExecutionGatePhase:\s*"P117"/.test(readiness) && /rolloutGate:\s*organizationBrandProvider/.test(readiness) && /publicAutoApplyAllowed:\s*false/.test(readiness) && /nextPhase:\s*"P119 - Creative Studio provider execution smoke and generated asset ingestion"/.test(readiness));
...
add("roadmap keeps P117 complete and P118 implemented", /Completed through \*\*P118 - Creative Studio organization-brand provider execution implementation\*\*/.test(roadmap) && /\| P117 \| Creative Studio organization-brand provider execution rollout gate\. \|/.test(roadmap) && /\| P118 \| Creative Studio organization-brand provider execution implementation\. \|/.test(roadmap) && /\| P119 \| Creative Studio provider execution smoke and generated asset ingestion\. \|/.test(roadmap));
add("source of truth keeps P117 rollout gate in current baseline", /after P118 Creative Studio organization-brand provider execution implementation/.test(sourceOfTruth) && /Creative Studio organization-brand provider execution rollout gate exists/.test(sourceOfTruth));
