...
add("organization brand live provider contract is unavailable and not called", /unavailable-live-contract/.test(readiness) && /live-openapi-does-not-expose-organization-brand-endpoints/.test(readiness) && !/\/v1\/organization-brand\/jobs/.test(service) && !/\/v1\/organization-brand\/jobs/.test(page));
...
add("README preserves completed P114 baseline", /P114 Creative Studio organization-brand generation readiness/.test(readme));
add("roadmap preserves P114 while tracking current AI media milestone", /BB-AI-MEDIA-ONLINE-MILESTONE-01/.test(roadmap) && /\| P114 \| Creative Studio organization-brand generation planning and readiness gate\. \|/.test(roadmap));
add("source of truth names P114 baseline and current AI media milestone", /BB-AI-MEDIA-ONLINE-MILESTONE-01/.test(sourceOfTruth) && /Creative Studio organization-brand generation readiness exists/.test(sourceOfTruth));
