...
add("organization brand generation remains disabled", /generationRequestEnabled:\s*false/.test(readiness) && /generationUiEnabled:\s*false/.test(readiness) && /providerContractReady:\s*false/.test(readiness));
...
add("dashboard renders organization brand plan without enabling generation form", /organizationBrandPlan/.test(page) && /providerContractReady/.test(page) && /supportedAssets\.map/.test(page) && !/startOrganizationBrandGeneration/.test(page));
...
add("README marks P114 complete and P115 next", /Latest completed implementation phase:\s+\*\*P114 - Creative Studio organization-brand generation planning and readiness gate\*\*/.test(readme) && /Recommended next phase:\s+\*\*P115 - Creative Studio organization logo and cover generation request controls\*\*/.test(readme));
add("roadmap marks P114 complete and P115 next", /Completed through \*\*P114 - Creative Studio organization-brand generation planning and readiness gate\*\*/.test(roadmap) && /\| P114 \| Creative Studio organization-brand generation planning and readiness gate\. \|/.test(roadmap) && /\| P115 \| Creative Studio organization logo and cover generation request controls\. \|/.test(roadmap));
add("source of truth names P114 baseline", /after P114 Creative Studio organization-brand generation planning and readiness gate/.test(sourceOfTruth) && /Creative Studio organization-brand generation readiness exists/.test(sourceOfTruth));
