...
add("roadmap keeps P115 complete in current progression", /Completed through \*\*P118 - Creative Studio organization-brand provider execution implementation\*\*/.test(roadmap) && /\| P115 \| Creative Studio organization logo and cover generation request controls\. \|/.test(roadmap) && /\| P119 \| Creative Studio provider execution smoke and generated asset ingestion\. \|/.test(roadmap));
add("source of truth keeps P115 controls in current baseline", /after P118 Creative Studio organization-brand provider execution implementation/.test(sourceOfTruth) && /Creative Studio organization logo and cover request controls exist/.test(sourceOfTruth));
