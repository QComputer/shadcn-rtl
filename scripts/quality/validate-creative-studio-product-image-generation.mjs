...
add("README preserves completed P112 baseline", /P112 Creative Studio product-image generation/.test(readme));
add("roadmap preserves P112 while tracking current AI media milestone", /\| P112 \| Creative Studio product-image generation request controls and long-running job UX\. \|/.test(roadmap) && /BB-AI-MEDIA-ONLINE-MILESTONE-01/.test(roadmap));
add("source of truth names P112 baseline and current AI media milestone", /Creative Studio product-image generation controls exist/.test(sourceOfTruth) && /BB-AI-MEDIA-ONLINE-MILESTONE-01/.test(sourceOfTruth));
