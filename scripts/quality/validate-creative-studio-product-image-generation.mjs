...
add("README marks P112 complete and P113 next", /Latest completed implementation phase:\s+\*\*P120D - SMS.ir provider completion\*\*/.test(readme) && /Recommended next phase:\s+\*\*P120E — SMS delivery reports and provider reconciliation\*\*/.test(readme));
add("roadmap marks P112 complete and P113 next", /Completed through \*\*P120D - SMS.ir provider completion\*\*/.test(roadmap) && /\| P112 \| Creative Studio product-image generation request controls and long-running job UX\. \|/.test(roadmap) && /\| P113 \| Creative Studio generated-asset selection polish and deployed acceptance\. \|/.test(roadmap));
add("source of truth names P112 baseline", /after P119 Creative Studio provider result ingestion and review stabilization/.test(sourceOfTruth) && /Creative Studio product-image generation controls exist/.test(sourceOfTruth));
