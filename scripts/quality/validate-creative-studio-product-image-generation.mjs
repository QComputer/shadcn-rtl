...
add("roadmap marks P112 complete and P113 next", /Completed through \*\*P114 - Creative Studio organization-brand generation planning and readiness gate\*\*/.test(roadmap) && /\| P112 \| Creative Studio product-image generation request controls and long-running job UX\. \|/.test(roadmap) && /\| P113 \| Creative Studio generated-asset selection polish and deployed acceptance\. \|/.test(roadmap));
add("source of truth names P112 baseline", /after P114 Creative Studio organization-brand generation planning and readiness gate/.test(sourceOfTruth) && /Creative Studio product-image generation controls exist/.test(sourceOfTruth));
