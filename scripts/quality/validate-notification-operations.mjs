...
add("roadmap marks P103 complete in P109 progression", /\| P103 \| Admin\/operator notification dashboard\. \|/.test(roadmap) && /Completed through \*\*P110 - Creative Studio apply controls and cache-safe public asset updates\*\*/.test(roadmap))
add("source of truth names P109 baseline", /after P110 Creative Studio apply controls and cache-safe public asset updates/.test(sourceOfTruth) && /Notification operations dashboard exists/.test(sourceOfTruth))
