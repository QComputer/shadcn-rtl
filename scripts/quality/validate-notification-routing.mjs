...
add("README keeps P102 complete while marking P109 latest", /\| 102 \| Notification templates, routing, and delivery policies/.test(readme) && /Latest completed implementation phase:\s+\*\*P113 - Creative Studio generated-asset selection polish and deployed acceptance\*\*/.test(readme) && /P114 - Creative Studio organization-brand generation planning and readiness gate/.test(readme))
add("roadmap marks P102 complete in P109 progression", /\| P102 \| Notification templates, routing, and delivery policies\. \|/.test(roadmap) && /Completed through \*\*P113 - Creative Studio generated-asset selection polish and deployed acceptance\*\*/.test(roadmap))
add("source of truth names P109 baseline", /after P113 Creative Studio generated-asset selection polish and deployed acceptance/.test(sourceOfTruth) && /Notification routing exists/.test(sourceOfTruth))
