...
const expectedE2E = [
  ...
  "scripts/e2e/deployed-creative-studio-generated-assets.mjs",
...
for (const rel of ["app/api/health/route.ts", "lib/runtime-env.ts", "scripts/quality/validate-env.mjs", "scripts/quality/validate-source-baseline.mjs", "scripts/quality/validate-open-fields-audit.mjs", "scripts/quality/validate-pwa-foundation.mjs", "scripts/quality/validate-pwa-offline-shell.mjs", "scripts/quality/validate-notification-preferences.mjs", "scripts/quality/validate-web-push-delivery.mjs", "scripts/quality/validate-sms-provider.mjs", "scripts/quality/validate-notification-routing.mjs", "scripts/quality/validate-notification-operations.mjs", "scripts/quality/validate-deployed-pwa-push-sms.mjs", "scripts/quality/validate-production-rollout-runbook.mjs", "scripts/quality/pwa-push-sms-acceptance.mjs", "scripts/quality/verify-clean-source.mjs", "scripts/quality/validate-creative-studio-planning.mjs", "scripts/quality/validate-creative-studio-foundation.mjs", "scripts/quality/validate-creative-studio-dashboard.mjs", "scripts/quality/validate-creative-studio-apply-controls.mjs", "scripts/quality/validate-creative-studio-generation-readiness.mjs", "scripts/quality/validate-creative-studio-product-image-generation.mjs", "scripts/quality/validate-creative-studio-generated-asset-selection.mjs", "scripts/quality/validate-creative-studio-organization-brand-readiness.mjs", "scripts/quality/validate-creative-studio-organization-brand-request-controls.mjs", "scripts/quality/validate-creative-studio-organization-brand-acceptance.mjs", "scripts/quality/validate-creative-studio-organization-brand-provider-rollout.mjs", "scripts/quality/validate-creative-studio-organization-brand-provider-execution.mjs", "scripts/quality/validate-creative-studio-provider-result-ingestion.mjs", "scripts/quality/validate-release-artifact.mjs", "scripts/quality/validate-get-purity.mjs", "scripts/quality/validate-database-drift.mjs", "scripts/quality/validate-tenant-identity.mjs", "scripts/quality/validate-commerce-correctness.mjs", "scripts/quality/validate-appointment-correctness.mjs", "scripts/quality/validate-i18n-rtl-audit.mjs", "scripts/quality/validate-i18n-completion.mjs", "scripts/quality/validate-fanpage-readiness.mjs",
  "scripts/quality/validate-public-experience.mjs", "scripts/quality/validate-fanpage-mvp.mjs", "scripts/quality/validate-seed-auth-members-cleanup.mjs", "scripts/quality/validate-member-provider-hardening.mjs", "scripts/quality/validate-dashboard-navigation-copy.mjs", "scripts/quality/validate-dashboard-role-navigation.mjs", "scripts/quality/validate-dashboard-route-parity.mjs", "scripts/quality/validate-dashboard-route-authorization.mjs", "scripts/quality/validate-dashboard-route-guard-smoke.mjs", "scripts/quality/validate-customer-club-foundation.mjs", "scripts/quality/validate-in-app-notifications.mjs", "scripts/quality/validate-customer-segments.mjs", "scripts/quality/validate-campaign-builder.mjs", "scripts/quality/validate-loyalty-coupons.mjs", "scripts/quality/validate-web-push-foundation.mjs", "scripts/quality/validate-public-seo.mjs", "scripts/quality/validate-public-seo-qa.mjs", "scripts/quality/validate-public-category-seo.mjs", "scripts/quality/validate-public-category-slugs-pagination.mjs", "scripts/quality/validate-public-detail-slugs.mjs", "scripts/quality/validate-deployed-slug-seo.mjs", "scripts/quality/validate-dashboard-slug-editing.mjs", "scripts/quality/validate-public-slug-preview-share.mjs", "scripts/quality/validate-tenant-og-images.mjs", "scripts/quality/validate-deployed-social-preview.mjs", "scripts/quality/validate-social-preview-evidence.mjs", "scripts/quality/validate-import-hub-foundation.mjs", "scripts/quality/validate-csv-excel-importer.mjs", "scripts/quality/validate-manual-instagram-import.mjs", "scripts/quality/validate-text-product-extraction.mjs", "scripts/quality/validate-image-pdf-menu-import.mjs", "scripts/quality/validate-snappfood-url-import.mjs", "scripts/quality/validate-snappmarket-url-import.mjs", "scripts/quality/validate-telegram-post-import.mjs", "scripts/quality/validate-external-source-mapping.mjs", "scripts/quality/validate-import-hub-audit-limits.mjs", "scripts/quality/validate-export-hub-foundation.mjs", "scripts/quality/validate-import-approval-publishing.mjs", "scripts/quality/validate-ai-media.mjs", "scripts/quality/validate-ai-media-health-gate.mjs", "scripts/quality/validate-ai-media-mock-flow.mjs", "scripts/quality/validate-ai-media-durable-storage.mjs", "scripts/quality/validate-deployed-ai-media-rollout.mjs", "scripts/quality/validate-ai-media-rollout-evidence.mjs", "scripts/quality/validate-ai-media-paid-provider-controls.mjs", "scripts/quality/validate-ai-media-cost-rollback.mjs", "scripts/quality/validate-ai-media-seller-state-ux.mjs", "scripts/quality/validate-export-downloads.mjs", "scripts/quality/validate-deployed-import-export-smoke.mjs", "scripts/release/archive-social-preview-evidence.mjs", "scripts/release/archive-ai-media-rollout-evidence.mjs", "scripts/release/archive-pwa-push-sms-rollout-evidence.mjs", "scripts/release/pwa-push-sms-acceptance-evidence.mjs", "scripts/db/repair-known-database-drift.mjs", "scripts/db/known-database-drift-repair.sql"]) {
  exists(rel) ? ok(`${rel} exists`) : fail(`${rel} exists`);
}

for (const rel of ["scripts/e2e/deployed-phase9-quality-gates.mjs", "scripts/e2e/deployed-phase10-auth-security.mjs", "scripts/e2e/deployed-phase11-health.mjs", "scripts/e2e/deployed-phase12-messaging.mjs", "scripts/e2e/deployed-phase13-catalog-hardening.mjs", "scripts/e2e/deployed-phase14-inventory-operations.mjs", "scripts/e2e/deployed-phase15-public-order-tracking.mjs", "scripts/e2e/deployed-phase16-engagement.mjs", "scripts/e2e/deployed-phase17-account-settings.mjs", "scripts/e2e/deployed-slug-seo.mjs", "scripts/e2e/deployed-social-preview.mjs", "scripts/e2e/deployed-pwa-push-sms-smoke.mjs", "scripts/e2e/deployed-creative-studio-generated-assets.mjs", "scripts/e2e/deployed-all.mjs", "scripts/quality/validate-env.mjs", "scripts/quality/validate-source-baseline.mjs", "scripts/quality/validate-open-fields-audit.mjs", "scripts/quality/validate-pwa-foundation.mjs", "scripts/quality/validate-pwa-offline-shell.mjs", "scripts/quality/validate-notification-preferences.mjs", "scripts/quality/validate-web-push-delivery.mjs", "scripts/quality/validate-sms-provider.mjs", "scripts/quality/validate-notification-routing.mjs", "scripts/quality/validate-notification-operations.mjs", "scripts/quality/validate-deployed-pwa-push-sms.mjs", "scripts/quality/validate-production-rollout-runbook.mjs", "scripts/quality/pwa-push-sms-acceptance.mjs", "scripts/quality/verify-clean-source.mjs", "scripts/quality/validate-creative-studio-planning.mjs", "scripts/quality/validate-creative-studio-foundation.mjs", "scripts/quality/validate-creative-studio-dashboard.mjs", "scripts/quality/validate-creative-studio-apply-controls.mjs", "scripts/quality/validate-creative-studio-generation-readiness.mjs", "scripts/quality/validate-creative-studio-product-image-generation.mjs", "scripts/quality/validate-creative-studio-generated-asset-selection.mjs", "scripts/quality/validate-creative-studio-organization-brand-readiness.mjs", "scripts/quality/validate-creative-studio-organization-brand-request-controls.mjs", "scripts/quality/validate-creative-studio-organization-brand-acceptance.mjs", "scripts/quality/validate-creative-studio-organization-brand-provider-rollout.mjs", "scripts/quality/validate-creative-studio-organization-brand-provider-execution.mjs", "scripts/quality/validate-creative-studio-provider-result-ingestion.mjs", "scripts/quality/validate-dashboard-access.mjs", "scripts/quality/validate-api-service-safety.mjs", "scripts/quality/validate-release-artifact.mjs", "scripts/quality/validate-get-purity.mjs", "scripts/quality/validate-database-drift.mjs", "scripts/quality/validate-tenant-identity.mjs", "scripts/quality/validate-commerce-correctness.mjs", "scripts/quality/validate-appointment-correctness.mjs", "scripts/quality/validate-i18n-rtl-audit.mjs", "scripts/quality/validate-i18n-completion.mjs", "scripts/quality/validate-fanpage-readiness.mjs",
  "scripts/quality/validate-public-experience.mjs", "scripts/quality/validate-fanpage-mvp.mjs", "scripts/quality/validate-seed-auth-members-cleanup.mjs", "scripts/quality/validate-member-provider-hardening.mjs", "scripts/quality/validate-dashboard-navigation-copy.mjs", "scripts/quality/validate-dashboard-role-navigation.mjs", "scripts/quality/validate-dashboard-route-parity.mjs", "scripts/quality/validate-dashboard-route-authorization.mjs", "scripts/quality/validate-dashboard-route-guard-smoke.mjs", "scripts/quality/validate-customer-club-foundation.mjs", "scripts/quality/validate-in-app-notifications.mjs", "scripts/quality/validate-customer-segments.mjs", "scripts/quality/validate-campaign-builder.mjs", "scripts/quality/validate-loyalty-coupons.mjs", "scripts/quality/validate-web-push-foundation.mjs", "scripts/quality/validate-public-seo.mjs", "scripts/quality/validate-public-seo-qa.mjs", "scripts/quality/validate-public-category-seo.mjs", "scripts/quality/validate-public-category-slugs-pagination.mjs", "scripts/quality/validate-public-detail-slugs.mjs", "scripts/quality/validate-deployed-slug-seo.mjs", "scripts/quality/validate-dashboard-slug-editing.mjs", "scripts/quality/validate-public-slug-preview-share.mjs", "scripts/quality/validate-tenant-og-images.mjs", "scripts/quality/validate-deployed-social-preview.mjs", "scripts/quality/validate-social-preview-evidence.mjs", "scripts/quality/validate-import-hub-foundation.mjs", "scripts/quality/validate-csv-excel-importer.mjs", "scripts/quality/validate-manual-instagram-import.mjs", "scripts/quality/validate-text-product-extraction.mjs", "scripts/quality/validate-image-pdf-menu-import.mjs", "scripts/quality/validate-snappfood-url-import.mjs", "scripts/quality/validate-snappmarket-url-import.mjs", "scripts/quality/validate-telegram-post-import.mjs", "scripts/quality/validate-external-source-mapping.mjs", "scripts/quality/validate-import-hub-audit-limits.mjs", "scripts/quality/validate-export-hub-foundation.mjs", "scripts/quality/validate-import-approval-publishing.mjs", "scripts/quality/validate-ai-media.mjs", "scripts/quality/validate-ai-media-health-gate.mjs", "scripts/quality/validate-ai-media-mock-flow.mjs", "scripts/quality/validate-ai-media-durable-storage.mjs", "scripts/quality/validate-deployed-ai-media-rollout.mjs", "scripts/quality/validate-ai-media-rollout-evidence.mjs", "scripts/quality/validate-ai-media-paid-provider-controls.mjs", "scripts/quality/validate-ai-media-cost-rollback.mjs", "scripts/quality/validate-ai-media-seller-state-ux.mjs", "scripts/quality/validate-export-downloads.mjs", "scripts/quality/validate-deployed-import-export-smoke.mjs", "scripts/release/archive-social-preview-evidence.mjs", "scripts/release/archive-ai-media-rollout-evidence.mjs", "scripts/release/archive-pwa-push-sms-rollout-evidence.mjs", "scripts/release/pwa-push-sms-acceptance-evidence.mjs", "scripts/db/repair-known-database-drift.mjs"]) {
...
if (exists("scripts/quality/validate-source-baseline.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-source-baseline.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P95 source baseline validator passes") : fail("P95 source baseline validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-open-fields-audit.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-open-fields-audit.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P96 open fields audit validator passes") : fail("P96 open fields audit validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-pwa-foundation.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-pwa-foundation.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P97 PWA foundation validator passes") : fail("P97 PWA foundation validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-pwa-offline-shell.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-pwa-offline-shell.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P98 PWA offline shell validator passes") : fail("P98 PWA offline shell validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-notification-preferences.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-notification-preferences.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P99 notification preferences validator passes") : fail("P99 notification preferences validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-web-push-delivery.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-web-push-delivery.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P100 Web Push delivery validator passes") : fail("P100 Web Push delivery validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-sms-provider.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-sms-provider.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P101 SMS provider validator passes") : fail("P101 SMS provider validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-notification-routing.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-notification-routing.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P102 notification routing validator passes") : fail("P102 notification routing validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-notification-operations.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-notification-operations.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P103 notification operations validator passes");
  } else {
    fail("P103 notification operations validator passes", result.stderr || result.stdout);
  }
}

if (exists("scripts/quality/validate-deployed-pwa-push-sms.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-deployed-pwa-push-sms.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P104 deployed PWA Push SMS validator passes");
  } else {
    fail("P104 deployed PWA Push SMS validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/validate-production-rollout-runbook.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-production-rollout-runbook.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P105 production rollout runbook validator passes");
  } else {
    fail("P105 production rollout runbook validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/pwa-push-sms-acceptance.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/pwa-push-sms-acceptance.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P106 PWA Push SMS acceptance validator passes");
  } else {
    fail("P106 PWA Push SMS acceptance validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/validate-creative-studio-planning.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-planning.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P107 Creative Studio planning validator passes");
  } else {
    fail("P107 Creative Studio planning validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/validate-creative-studio-foundation.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-foundation.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P108 Creative Studio foundation validator passes");
  } else {
    fail("P108 Creative Studio foundation validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/validate-creative-studio-dashboard.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-dashboard.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P109 Creative Studio dashboard validator passes");
  } else {
    fail("P109 Creative Studio dashboard validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/validate-creative-studio-apply-controls.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-apply-controls.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P110 Creative Studio apply controls validator passes");
  } else {
    fail("P110 Creative Studio apply controls validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/validate-creative-studio-generation-readiness.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-generation-readiness.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P111 Creative Studio generation readiness validator passes");
  } else {
    fail("P111 Creative Studio generation readiness validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/validate-creative-studio-product-image-generation.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-product-image-generation.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P112 Creative Studio product image generation validator passes");
  } else {
    fail("P112 Creative Studio product image generation validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/validate-creative-studio-generated-asset-selection.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-generated-asset-selection.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P113 Creative Studio generated asset selection validator passes");
  } else {
    fail("P113 Creative Studio generated asset selection validator passes", result.stderr || result.stdout);
  }
}
if (exists("scripts/quality/validate-creative-studio-organization-brand-readiness.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-organization-brand-readiness.mjs"], { cwd: root, encoding: "utf8" });
  if (result.status === 0) {
    ok("P114 Creative Studio organization brand readiness validator passes");
  } else {
    fail("P114 Creative Studio organization brand readiness validator passes", result.stderr || result.stdout);
  }
}
  if (exists("scripts/quality/validate-creative-studio-organization-brand-request-controls.mjs")) {
    const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-organization-brand-request-controls.mjs"], { cwd: root, encoding: "utf8" });
    if (result.status === 0) {
      ok("P115 Creative Studio organization brand request controls validator passes");
    } else {
      fail("P115 Creative Studio organization brand request controls validator passes", result.stderr || result.stdout);
    }
  }
  if (exists("scripts/quality/validate-creative-studio-organization-brand-acceptance.mjs")) {
    const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-organization-brand-acceptance.mjs"], { cwd: root, encoding: "utf8" });
    if (result.status === 0) {
      ok("P116 Creative Studio organization brand acceptance validator passes");
    } else {
      fail("P116 Creative Studio organization brand acceptance validator passes", result.stderr || result.stdout);
    }
  }
  if (exists("scripts/quality/validate-creative-studio-organization-brand-provider-rollout.mjs")) {
    const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-organization-brand-provider-rollout.mjs"], { cwd: root, encoding: "utf8" });
    if (result.status === 0) {
      ok("P117 Creative Studio organization brand provider rollout validator passes");
    } else {
      fail("P117 Creative Studio organization brand provider rollout validator passes", result.stderr || result.stdout);
    }
  }

  if (exists("scripts/quality/validate-creative-studio-organization-brand-provider-execution.mjs")) {
    const result = spawnSync(process.execPath, ["scripts/quality/validate-creative-studio-organization-brand-provider-execution.mjs"], { cwd: root, encoding: "utf8" });
    if (result.status === 0) {
      ok("P118 Creative Studio organization brand provider execution validator passes");
    } else {
      fail("P118 Creative Studio organization brand provider execution validator passes", result.stderr || result.stdout);
    }
  }
...
if (exists("scripts/quality/validate-creative-studio-provider-result-ingestion.mjs")) {
  ...
  if (exists("scripts/quality/validate-customer-order-lifecycle-notifications.mjs")) {
    const result = spawnSync(process.execPath, ["scripts/quality/validate-customer-order-lifecycle-notifications.mjs"], { cwd: root, encoding: "utf8" });
    if (result.status === 0) {
      ok("P120B customer order lifecycle notifications validator passes");
    } else {
      fail("P120B customer order lifecycle notifications validator passes", result.stderr || result.stdout);
    }
  }

  if (exists("scripts/quality/validate-guest-sms-dry-run.mjs")) {
    const result = spawnSync(process.execPath, ["scripts/quality/validate-guest-sms-dry-run.mjs"], { cwd: root, encoding: "utf8" });
    if (result.status === 0) {
      ok("P120B guest SMS dry-run validator passes");
    } else {
      fail("P120B guest SMS dry-run validator passes", result.stderr || result.stdout);
    }
  }
...
if (exists("scripts/quality/validate-ai-media-health-gate.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-ai-media-health-gate.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P84 AI media health gate validator passes") : fail("P84 AI media health gate validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-ai-media-mock-flow.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-ai-media-mock-flow.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P85 AI media MOCK flow validator passes") : fail("P85 AI media MOCK flow validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-ai-media-durable-storage.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-ai-media-durable-storage.mjs"], { cwd: root, encoding: "utf8" });
...
if (exists("scripts/quality/validate-ai-media-usage-controls.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-ai-media-usage-controls.mjs"], { cwd: root, encoding: "utf8" });
...
if (exists("scripts/quality/validate-deployed-ai-media-rollout.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-deployed-ai-media-rollout.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P90 deployed AI media rollout validator passes") : fail("P90 deployed AI media rollout validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-ai-media-rollout-evidence.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-ai-media-rollout-evidence.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P91 AI media rollout evidence validator passes") : fail("P91 AI media rollout evidence validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-ai-media-paid-provider-controls.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-ai-media-paid-provider-controls.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P92 AI media paid provider controls validator passes") : fail("P92 AI media paid provider controls validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-ai-media-cost-rollback.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-ai-media-cost-rollback.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P93 AI media cost rollback validator passes") : fail("P93 AI media cost rollback validator passes", result.stderr || result.stdout);
}

if (exists("scripts/quality/validate-ai-media-seller-state-ux.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-ai-media-seller-state-ux.mjs"], { cwd: root, encoding: "utf8" });
...
if (exists("scripts/quality/validate-deployed-import-export-smoke.mjs")) {
  const result = spawnSync(process.execPath, ["scripts/quality/validate-deployed-import-export-smoke.mjs"], { cwd: root, encoding: "utf8" });
  result.status === 0 ? ok("P82 deployed import/export smoke validator passes") : fail("P82 deployed import/export smoke validator passes", result.stderr || result.stdout);
}
