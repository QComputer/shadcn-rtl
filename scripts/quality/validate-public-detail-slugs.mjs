...
expectIncludes("app/[locale]/[slug]/shop/product/[productId]/layout.tsx", "redirect(redirectContext.path)", "product detail redirects id URL to canonical slug URL");
expectIncludes(
  "app/[locale]/[slug]/appointment/services/[serviceId]/layout.tsx",
...
for (const [rel, needle, label] of [
  ["app/[locale]/[slug]/shop/page.tsx", "product.slug || product.id", "shop cards prefer product slugs"],
  ["app/[locale]/[slug]/shop/category/[categoryId]/page.tsx", "product.slug || product.id", "shop category cards and JSON-LD prefer product slugs"],
  ["app/[locale]/[slug]/appointment/page.tsx", "service.slug || service.id", "appointment landing service cards prefer service slugs"],
  ["app/[locale]/[slug]/appointment/services/page.tsx", "service.slug || service.id", "appointment services cards prefer service slugs"],
  ["app/[locale]/[slug]/appointment/services/category/[categoryId]/page.tsx", "service.slug || service.id", "service category cards and JSON-LD prefer service slugs"],
