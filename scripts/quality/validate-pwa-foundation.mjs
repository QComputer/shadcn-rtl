...
add("README keeps P97 complete while marking P107 latest", /\| 97 \| PWA foundation and install experience/.test(readme) && /Latest completed implementation phase:\s+\*\*P107 - Creative Studio integration planning for main Bazar Baz\*\*/.test(readme) && /P108 - Creative Studio server foundation/.test(readme))
add("roadmap keeps P97 complete while marking P107 baseline", /\| P97 \| PWA foundation and install experience\. \|/.test(roadmap) && /Completed through \*\*P107 - Creative Studio integration planning for main Bazar Baz\*\*/.test(roadmap))
add("source of truth keeps P97 foundation while naming P107 baseline", /PWA Foundation and Install Experience exists/.test(sourceOfTruth) && /after P107 Creative Studio integration planning/.test(sourceOfTruth))
