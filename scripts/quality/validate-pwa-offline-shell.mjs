...
add("README marks P98 latest and P99 next", /Latest completed implementation phase:\s+\*\*P98 - Offline shell, caching, and PWA quality gates\*\*/.test(readme) && /Recommended next phase:\s+\*\*P99 - Notification domain model and preferences\*\*/.test(readme))
add("roadmap marks P98 complete and P99 next", /Completed through \*\*P98 - Offline shell, caching, and PWA quality gates\*\*/.test(roadmap) && /P99 - Notification domain model and preferences/.test(roadmap))
add("source of truth names P98 baseline", /after P98 offline shell, caching, and PWA quality gates/.test(sourceOfTruth))
