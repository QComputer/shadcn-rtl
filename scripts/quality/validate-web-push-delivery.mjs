...
add("roadmap marks P100 complete and P101 next", /Completed through \*\*P100 - Web Push notification service\*\*/.test(roadmap) && /P101 - SMS provider abstraction and sms\.ir integration/.test(roadmap))
add("source of truth names P100 baseline", /after P100 Web Push notification service/.test(sourceOfTruth) && /Web Push notification service exists/.test(sourceOfTruth))
